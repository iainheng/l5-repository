...
class RequestCriteria implements CriteriaInterface
{
    ...
    public function apply($model, RepositoryInterface $repository)
    {
        ...
        $search = $this->request->input(config('repository.criteria.params.search', 'search'), null);
        $searchFields = $this->request->input(config('repository.criteria.params.searchFields', 'searchFields'), null);
        $filter = $this->request->input(config('repository.criteria.params.filter', 'filter'), null);
        $orderBy = $this->request->input(config('repository.criteria.params.orderBy', 'orderBy'), null);
        $sortedBy = $this->request->input(config('repository.criteria.params.sortedBy', 'sortedBy'), 'asc');
        $with = $this->request->input(config('repository.criteria.params.with', 'with'), null);
        $withCount = $this->request->input(config('repository.criteria.params.withCount', 'withCount'), null);
        $searchJoin = $this->request->input(config('repository.criteria.params.searchJoin', 'searchJoin'), null);
